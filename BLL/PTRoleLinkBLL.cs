...
{
    /// <summary>
    /// 对象名称：角色权限关联表业务逻辑类（业务逻辑层）
    /// 对象说明：关联角色和系统功能，多对多关系
    /// 调用说明：本类提供了各种业务逻辑方法，供用户界面层或其它业务逻辑层中的类进行调用。
    /// 作者姓名：牛大宝
    /// 编写日期：2013-8-6 15:37:18
    /// </summary>
    public class PTRoleLinkBLL
    {
        ...
        /// </summary>
        internal static DAL.Common.PTRoleLinkDAL DataAccess
        {
            get
            {
                return DAL.Common.PTRoleLinkDAL.Instance;
            }
        }
        ...
        /// </summary>
        /// <param name="pTRoleLink">角色权限关联表（PTRoleLink）实例对象</param>
        public static int Insert(PTRoleLink pTRoleLink)
        {
            CheckValid(pTRoleLink);
            return DataAccess.Insert(pTRoleLink);
        }
        ...
        /// </summary>
        /// <param name="pTRoleLink">角色权限关联表（PTRoleLink）实例对象</param>
        public static int Update(PTRoleLink pTRoleLink)
        {
            CheckValid(pTRoleLink);
            return DataAccess.Update(pTRoleLink);
        }
        ...
        /// </summary>
        /// <param name="id">角色权限关联表（PTRoleLink）的主键“序号（Id）”</param>
        public static PTRoleLink GetDataById(int id)
        {
        ...
        /// </summary>
        /// <param name="id">角色权限关联表（PTRoleLink）的主键“序号（Id）”</param>
        public static PTRoleLink GetDataById(string id)
        {
