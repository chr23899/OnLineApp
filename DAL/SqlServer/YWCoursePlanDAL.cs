    ...
    public class YWCoursePlanDAL : DAL.Common.YWCoursePlanDAL
    {
        ...
        public override int Insert(YWCoursePlan yWCoursePlan)
        {
            ...
            SqlParameter[] parameters = 
            {
                ...
                new SqlParameter("@video"      , SqlDbType.NVarChar , 500){ Value = yWCoursePlan.Video      },
                new SqlParameter("@study"      , SqlDbType.NVarChar , 500){ Value = yWCoursePlan.Study      },
                new SqlParameter("@test"       , SqlDbType.NVarChar , 500){ Value = yWCoursePlan.Test       },
